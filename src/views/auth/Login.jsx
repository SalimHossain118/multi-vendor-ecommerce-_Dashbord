      ...
      <div className="w-[350px] text-[#d0d2d6] p-2">
        <div className="bg-[#283046] p-4 rounded-md">
          ...
          <p className="text-sm mb-3">
            Please Login to your account to continue your bussiness
          </p>
          <form onSubmit={submit}>
            ...
            <button className="bg-blue-500 w-full hover:shadow-blue-500/20 hover:shadow-lg text-white rounded-md px-7 py-2 mb-5">
              Login
            </button>
